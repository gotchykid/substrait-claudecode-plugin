...
3. **Run it:**
   `bash "${CLAUDE_PLUGIN_ROOT}/scripts/substrait-link.sh" logout [--project] [--revoke|--keep-token]`
...
Note: the **"Substrait deployment" block in `CLAUDE.md`** is deliberately left in place —
